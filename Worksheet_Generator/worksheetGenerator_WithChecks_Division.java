...
public class worksheetGenerator_WithChecks_Division
{
    ...
    public static int[] solutions1 = new int[10];
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        fileName2 = operator_String.concat("_") + max + "_" + lowerLimit + "-" + upperLimit + "_" + staticNum + "_Horozontal" + ".csv";
        ...
        PrintWriter fileWriter2 = new PrintWriter("/mnt/c/Users/Clayton/Documents/GitHub/SchoolAids/Worksheet_Generator/Worksheets/".concat(fileName2));
        ...
        for(int i = 0; i < 5; i++){
            ...
            write2ndTopProblemSet(nums1, denoms1, operators1, solutions1, fileWriter2);
        }
        ...
        for(int i = 0; i < 10; i++){
            ...
            write2ndBotProblemSet(nums2, denoms2, operators2, solutions2, fileWriter2);
        }
        fileWriter.close();
        fileWriter2.close();
        System.out.printf("%s created!\n", fileName);
        System.out.printf("%s create! \n", fileName2);
    }
    ...
    public static void writeTopProblemSet(int[] nums, int[] denoms, String[] operators, int[] solutions, PrintWriter fileWriter){
        ...
        fileWriter.printf("%d,%d,,%d,%d,,%d,%d,,%d,%d,,%d,%d\n",denoms[0], nums[0], denoms[1], nums[1], denoms[2], nums[2], denoms[3], nums[3], denoms[4], nums[4]);
        fileWriter.printf("\n");
    }
    ...
    public static void writeBotProblemSet(int[] nums, int[] denoms, String[] operators, int[] solutions, PrintWriter fileWriter){
        ...
        fileWriter.printf(",%d,,,%d,,,%d,,,%d,,,%d,,,%d,,,%d,,,%d,,,%d\n", solutions[0], solutions[1], solutions[2], solutions[3], solutions[4], solutions[5], solutions[6], solutions[7], solutions[8]);
        fileWriter.printf("%d,%d,,%d,%d,,%d,%d,,%d,%d,,%d,%d,,%d,%d,,%d,%d,,%d,%d,,%d,%d\n", denoms[0], nums[0], denoms[1], nums[1], denoms[2], nums[2], denoms[3], nums[3], denoms[4], nums[4], denoms[5], nums[5], denoms[6], nums[6], denoms[7], nums[7], denoms[8], nums[8]);
        fileWriter.printf("\n");
    }

    //Method to write data to .CSV file for top set of problems
    public static void write2ndTopProblemSet(int[] nums, int[] denoms, String[] operators, int[] solutions, PrintWriter fileWriter){
        //Print statment for debugging
        // System.out.printf("writeTopProblemSet() called!\n");
    ...
    //Method to write data to .CSV file for bottom set of problems
    public static void write2ndBotProblemSet(int[] nums, int[] denoms, String[] operators, int[] solutions, PrintWriter fileWriter){
